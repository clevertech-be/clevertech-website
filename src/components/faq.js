  ...
  return (
    <section className=''>
      <div className='py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 '>
        <h2 className='mb-6 lg:mb-8 text-3xl lg:text-4xl tracking-tight font-extrabold text-center text-white'>
        ...
        <div className='mx-auto max-w-screen-md'>
          ...
          >
            <h2 id='accordion-flush-heading-1'>
              <button
                type='button'
                className='flex justify-between items-center py-5 w-full font-medium text-left text-white border-b border-white'
            ...
            <h2 id='accordion-flush-heading-2'>
              <button
                type='button'
                className='flex justify-between items-center py-5 w-full font-medium text-left text-white/60 border-b border-white'
