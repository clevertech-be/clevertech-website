      ...
      <div className='max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24'>
        ...
        <div className='grid grid-cols-1 mt-12 gap-y-12 gap-x-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
          ...
          <div>
            ...
            <div className='mt-4 space-y-2'>
              <div>
                <h3 className='text-xl font-bold text-gray-900 dark:text-white'>Joseph McFallen</h3>
                <p className='text-base font-medium text-gray-500 dark:text-gray-400'>
                  Senior Front-end Developer
                </p>
              </div>
          ...
          <div>
            ...
            <div className='mt-4 space-y-2'>
              <div>
                ...
                <p className='text-base font-medium text-gray-500 dark:text-gray-400'>Accountant</p>
              </div>
              <p className='text-base font-normal text-gray-500 dark:text-gray-400'>
                Bonnie drives the technical strategy of the themesberg platform and brand.
              </p>
          ...
          <div>
            ...
            <div className='mt-4 space-y-2'>
              <div>
                ...
                <p className='text-base font-medium text-gray-500 dark:text-gray-400'>Marketing</p>
              </div>
              <p className='text-base font-normal text-gray-500 dark:text-gray-400'>
                Bonnie drives the technical strategy of the themesberg platform and brand.
              </p>
